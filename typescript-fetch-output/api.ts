...
const BASE_PATH = "https://virtserver.swaggerhub.com/burkeda13/IOTTemplate/1.0.0".replace(/\/+$/, "");
...
export const DeviceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @param {DeviceRegistrationInfo} [device] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        register(device?: DeviceRegistrationInfo, options: any = {}): FetchArgs {
            const localVarPath = `/devices`;
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const DeviceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        register(device?: DeviceRegistrationInfo, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = DeviceApiFetchParamCreator(configuration).register(device, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const DeviceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        register(device?: DeviceRegistrationInfo, options?: any) {
            return DeviceApiFp(configuration).register(device, options)(fetch, basePath);
        },
    };
};
...
export class DeviceApi extends BaseAPI {
     ...
     * @memberof DeviceApi
     */
    public register(device?: DeviceRegistrationInfo, options?: any) {
        return DeviceApiFp(this.configuration).register(device, options)(this.fetch, this.basePath);
    }
...
export const EnvironmentApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} zoneId 
         * @param {'false' | 'true'} state 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setHeaterState(zoneId: string, state: 'false' | 'true', options: any = {}): FetchArgs {
            // verify required parameter 'zoneId' is not null or undefined
            if (zoneId === null || zoneId === undefined) {
...
export const EnvironmentApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        setHeaterState(zoneId: string, state: 'false' | 'true', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiResponse> {
...
export const EnvironmentApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        setHeaterState(zoneId: string, state: 'false' | 'true', options?: any) {
...
export class EnvironmentApi extends BaseAPI {
     ...
     * @memberof EnvironmentApi
     */
    public setHeaterState(zoneId: string, state: 'false' | 'true', options?: any) {
...
export const ZWaveApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'seconds' | 'minutes' | 'milliseconds'} [units] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setDimmerTimer(deviceId: string, value: number, timeunit: number, units?: 'seconds' | 'minutes' | 'milliseconds', options: any = {}): FetchArgs {
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
         ...
         * @throws {RequiredError}
         */
        setSwitch(deviceId: string, value: 'true' | 'false', options: any = {}): FetchArgs {
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
         ...
         * @throws {RequiredError}
         */
        setSwitchTimer(deviceId: string, value: 'true' | 'false', minutes: number, options: any = {}): FetchArgs {
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
...
export const ZWaveApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        setDimmerTimer(deviceId: string, value: number, timeunit: number, units?: 'seconds' | 'minutes' | 'milliseconds', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiResponse> {
         ...
         * @throws {RequiredError}
         */
        setSwitch(deviceId: string, value: 'true' | 'false', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiResponse> {
         ...
         * @throws {RequiredError}
         */
        setSwitchTimer(deviceId: string, value: 'true' | 'false', minutes: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiResponse> {
...
export const ZWaveApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        setDimmerTimer(deviceId: string, value: number, timeunit: number, units?: 'seconds' | 'minutes' | 'milliseconds', options?: any) {
         ...
         * @throws {RequiredError}
         */
        setSwitch(deviceId: string, value: 'true' | 'false', options?: any) {
         ...
         * @throws {RequiredError}
         */
        setSwitchTimer(deviceId: string, value: 'true' | 'false', minutes: number, options?: any) {
...
export class ZWaveApi extends BaseAPI {
     ...
     * @memberof ZWaveApi
     */
    public setDimmerTimer(deviceId: string, value: number, timeunit: number, units?: 'seconds' | 'minutes' | 'milliseconds', options?: any) {
     ...
     * @memberof ZWaveApi
     */
    public setSwitch(deviceId: string, value: 'true' | 'false', options?: any) {
     ...
     * @memberof ZWaveApi
     */
    public setSwitchTimer(deviceId: string, value: 'true' | 'false', minutes: number, options?: any) {
...
export const ZonesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @param {'basement' | 'first-floor' | 'second-floor'} zoneId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        quietZone(zoneId: 'basement' | 'first-floor' | 'second-floor', options: any = {}): FetchArgs {
            // verify required parameter 'zoneId' is not null or undefined
            if (zoneId === null || zoneId === undefined) {
...
export const ZonesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        quietZone(zoneId: 'basement' | 'first-floor' | 'second-floor', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
...
export const ZonesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        quietZone(zoneId: 'basement' | 'first-floor' | 'second-floor', options?: any) {
...
export class ZonesApi extends BaseAPI {
     ...
     * @memberof ZonesApi
     */
    public quietZone(zoneId: 'basement' | 'first-floor' | 'second-floor', options?: any) {
